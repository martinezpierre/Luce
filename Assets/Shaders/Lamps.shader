...
Shader "Luce/Lamps" {
    Properties {
        ...
        _LightOn_colour ("LightOn_colour", Color) = (1,0.6878296,0.4044118,1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
