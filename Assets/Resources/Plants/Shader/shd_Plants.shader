    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                v.vertex.xyz += ((_WindDirection.rgb*(mul(_Object2World, v.vertex).rgb*(mul(_Object2World, v.vertex).g-objPos.g)).r)*sin((3.141592654+(node_5536.g*_Vitesse)))*_Amplitude);
